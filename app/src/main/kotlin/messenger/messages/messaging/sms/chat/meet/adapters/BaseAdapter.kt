...
import messenger.messages.messaging.sms.chat.meet.listners.ActionModeListner
...
abstract class BaseAdapter(
    val mActivity: BaseActivity, val recyclerView: CustomRecyclerView, val fastScroller: FastScrolling? = null,
    ...
    open inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun viewClicked(any: Any) {
            Log.d("TAG_MESSAGE", "viewClicked: ${actModeCallback.isSelectable}")
