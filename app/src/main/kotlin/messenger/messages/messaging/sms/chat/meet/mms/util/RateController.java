...
package messenger.messages.messaging.sms.chat.meet.mms.util;
...
public class RateController {
    ...
    public static final String RATE_LIMIT_SURPASSED_ACTION =
        "messenger.messages.messaging.sms.chat.meet.mms.RATE_LIMIT_SURPASSED";
    public static final String RATE_LIMIT_CONFIRMED_ACTION =
        "messenger.messages.messaging.sms.chat.meet.mms.RATE_LIMIT_CONFIRMED";
    ...
    synchronized public boolean isAllowedByUser() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            mContext.registerReceiver(mBroadcastReceiver,
                new IntentFilter(RATE_LIMIT_CONFIRMED_ACTION), Context.RECEIVER_EXPORTED);
        } else {
            mContext.registerReceiver(mBroadcastReceiver,
