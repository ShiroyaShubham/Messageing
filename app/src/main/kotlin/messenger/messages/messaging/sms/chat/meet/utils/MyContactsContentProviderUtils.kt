...
import messenger.messages.messaging.sms.chat.meet.extensions.getIntValue
...
class MyContactsContentProviderUtils {
    companion object {
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<ContactsModel> {
            ...
            if (packageName != "com.myapp.dialer" && packageName != "messenger.messages.messaging.sms.chat.meet" && packageName != "com.myapp.calendar.pro") {
                return contacts
            }
