...
import messenger.messages.messaging.sms.chat.meet.extensions.getMyContactsCursor
...
class SMS_Service_Sended_Status_Receiver : SentReceiver() {
    ...
    override fun onMessageStatusUpdated(context: Context, intent: Intent, receiverResultCode: Int) {
        if (intent.extras?.containsKey("message_uri") == true) {
            ...
            ensureBackgroundThread {
                ...
                Log.e("TAG_REFRESH: ", " SMS_Service_Sended_Status_Receiver onMessageStatusUpdated")
    ...
    private fun showNotification(context: Context, recipientName: String, threadId: Long) {
        ...
        val pendingIntent = PendingIntent.getActivity(
            ...
            threadId.hashCode(),
            intent,
            returnPendingIntentFlag(PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE),
            Bundle()
        )
